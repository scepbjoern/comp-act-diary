...
| Etappe 0.2: ci-workflow (GitHub Action: tsc, lint, test:run bei main-Push und PRs) | planned | nein | `docs/project/features/ci-workflow/plan-v001.md` | 2026-07-07 |
| Etappe 0 (Rest): Review-Quick-Wins (actions→Services, Upload-Härtung, Hygiene) | planned | – | siehe `docs/project/ROADMAP.md` | 2026-07-06 |
