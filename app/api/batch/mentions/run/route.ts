/**
 * POST /api/batch/mentions/run
 * Executes batch mention detection on multiple journal entries.
 */
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await runBatchMentionDetection({
      userId,
      ...parsed.data,
    })
    ...
    console.error('POST /api/batch/mentions/run failed', error)
    return NextResponse.json(
