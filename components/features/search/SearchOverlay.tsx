...
import { SearchResultsPanel } from '@/components/features/search/SearchResultsPanel';
import { SearchFilterChips } from '@/components/features/search/SearchFilterChips';
