...
const iconMap: Record<string, typeof IconSettings> = {
  ...
  date_range: IconCalendarEvent,
  event: IconCalendarEvent,
  trending_up: IconTrendingUp,
  timeline: IconChartLine,
  ...
  person: IconUser,
  place: IconMapPin,
  handshake: IconUserPlus,
  sync: IconCloudDownload,
  cloud_sync: IconCloudDownload,
  pending_actions: IconClockHour4,
  category: IconCategory,
  task_alt: IconListCheck,
  self_improvement: IconLeaf,
  psychology: IconBrain,
  psychology_alt: IconBrain,
  favorite: IconHeart,
  smart_toy: IconRobot,
  auto_awesome: IconWand,
  record_voice_over: IconSpeakerphone,
  document_scanner: IconScan,
  summarize: IconFileDescription,
  photo_camera: IconCamera,
  mic: IconMicrophone,
  my_location: IconMapPin,
